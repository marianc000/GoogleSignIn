...
//            cookiepolicy: 'single_host_origin',
            ...
            redirect_uri: 'http://localhost:8080/mavenproject14/' //If using ux_mode='redirect', this parameter allows you to override the default redirect_uri that will be used at the end of the consent flow. 
                    //// The default redirect_uri is the current URL stripped of query parameters and hash fragment.
        }).then(function (googleAuth) {
            console.log('init');
            auth2 = googleAuth;
            auth2.then(function () {
                console.log(">loaded googleAuth");
